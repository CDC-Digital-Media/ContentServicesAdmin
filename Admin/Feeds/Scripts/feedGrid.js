...
(function ($) {
    ...
    $.fn[PLUGIN_NAME] = function (options) {
        ...
        function refreshMediaTable() {
            ...
            $(options.target).empty().load("Templates/feedGrid.htm", function () {
                buildMediaTable();
            });
        }
        ...
        function buildMediaTable() {
            ...
            var bindDatatable = function () {
                ...
                oTable = $(options.target).find("#feedGrid").dataTable({
                    "bServerSide": true,
                    "sAjaxSource": getUrl(),
                    "aaSorting": getSort(),
                    ...
                    "aoColumnDefs": [
                        {
                        	"mRender": function (data, type, row) {
                        		...
                        		//var feedname = row.mediaType === "Feed - Proxy" ? "Proxy Feed" : row.mediaType === "Feed - Import" ? "Import Feed" : "Feed";
                        		return getFeedTypePill(row.mediaType, row.sourceUrl);
                            },
                            "aTargets": [2]
                        },
                        {
                        ...
                        {
                            "mRender": function (data, type, row) {
                                var out = '<a class="btn btn-small btn-primary btnEdit" mediaId="' + row.mediaId + '" mediaType="'+ row.mediaType +'" style="color: white;" href="#">Feed Detail</a>';
                                return out;
                            },
                            "aTargets": [7]
                        },
        ...
        var setupButtonEvents = function(){
            $("#feedGrid .btnEdit").click(function () {
                ...
                document.location = urlRoot + "/Feeds/Feeds.htm?view=detail&id=" + mediaId;
                return false;
            });

            $("#feedGrid .btnManage").click(function () {
