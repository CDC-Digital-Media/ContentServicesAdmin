(function ($) {
    ...
    $.fn[PLUGIN_NAME] = function (options) {
        ...
        var loadPage = function (media) {
            ...
            $(options.target).load(options.templatePath + "Templates/AddHtmlContent.htm", function () {
                ...
                if (document.location.toString().toLowerCase().indexOf('capture') > -1) {
                	...
                	$target.find(".navigation").show();
                }
                else {
                	$target.find(".typeHeader").text("");
                	$target.find(".navigation").hide();
                }
                ...
                var $htmlResourceDiv = $("<div class='resources'>").appendTo(".detail");
                _resources = $htmlResourceDiv.HtmlResources({
                    media: _media,
                    onContinue: function () {
                ...
                if (!options.testOnly) {
                	...
                	_generalBlock = $generalBlockDiv.generalBlock({
                		media: _media,
                		onSourceUrlEdit: setupValidationDisplay,
        ...
        var saveMedia = function () {
            ...
            var onSuccessfulSave = function (oMedia, runThumbnail) {
                ...
                _resources.updateControl(_media);
                _categoryBlock.updateControl(_media);
