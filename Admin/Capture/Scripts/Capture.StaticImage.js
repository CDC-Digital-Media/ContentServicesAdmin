(function ($) {
    var PLUGIN_NAME = 'captureStaticImage';
    ...
    $.fn[PLUGIN_NAME] = function (options) {
        ...
        //var _embedCodeTemplate = '<a href="{1}" title="{3}"><img src="{0}" alt="{3}"/></a>';
        ...
        var loadPage = function (media) {
            ...
            $(options.target).load("Templates/AddStaticImageContent.htm", function () {
                ...
                _resources = $resources.staticImageResources({
                    media: _media,
                    onContinue: function () {
